...
const PLANS = [
  ...
  },
  {
    ...
    features: ["Track up to 5 websites", "All configured AI providers", "Plan-based monitoring", "5 tracked competitors", "AI fix recommendations", "Email alerts"],
    highlighted: true,
  },
  {
    name: "Enterprise",
    ...
    features: ["Unlimited websites", "Priority scan cadence", "Unlimited competitors", "Executive reporting", "API access", "Dedicated support"],
    highlighted: false,
  },
]
