...
const PLATFORMS = ["ChatGPT", "Gemini", "Claude", "Perplexity", "Microsoft Copilot", "Grok"]
  ...
  return (
    <section className="landing-root relative py-24 border-t border-white/5">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          <p className="text-lg md:text-xl text-white/60 font-normal leading-relaxed max-w-2xl mx-auto">
            Trusted by marketing, SEO, and brand teams measuring their presence across six major AI engines.
          </p>
        </motion.div>
