        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link href="/features/ai-visibility-dashboard" className="hover:text-primary transition-colors">AI Visibility Tracking</Link></li>
              <li><Link href="/generative-engine-optimization" className="hover:text-primary transition-colors">AI Search Optimization</Link></li>
              <li><Link href="/answer-engine-optimization" className="hover:text-primary transition-colors">ChatGPT SEO</Link></li>
              <li><Link href="/features/share-of-voice" className="hover:text-primary transition-colors">LLM Share of Voice</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              ...
              <li><Link href="/academy" className="hover:text-primary transition-colors">GEO Guidelines</Link></li>
