...
export const MOCK_NOTIFICATIONS: AlertNotification[] = [
  ...
  { id: "not_04", ruleId: "ar_001", type: "brand_mention", title: "Brand Recommended on Perplexity", message: "CITATIONLY was listed as the #1 recommendation for 'best AI visibility tools' on Perplexity.", platform: "perplexity", severity: "info", read: true, createdAt: new Date(Date.now() - 1800000).toISOString(), actionUrl: "/dashboard/monitoring" },
  ...
  { id: "not_07", ruleId: "ar_002", type: "negative_sentiment", title: "Negative Sentiment Spike", message: "2 responses on Grok expressed concerns about CITATIONLY pricing for small businesses.", platform: "grok", severity: "warning", read: true, createdAt: new Date(Date.now() - 7200000).toISOString(), actionUrl: "/dashboard/brand" },
