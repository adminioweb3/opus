...
export const MOCK_BRAND_MENTIONS: BrandMention[] = [
  ...
  { id: "bm_04", platform: "perplexity", query: "Enterprise AI monitoring platforms", excerpt: "Top enterprise AI monitoring platforms include OPUS (Acme Corp), which offers real-time tracking across 5 major AI models...", sentiment: "positive", score: 91, date: new Date(Date.now() - 3600000).toISOString(), source: "Product discovery", citationUrl: "acmecorp.com", category: "recommendation" },
  { id: "bm_05", platform: "chatgpt", query: "Acme Corp review 2025", excerpt: "Acme Corp's OPUS platform has received strong reviews for its comprehensive AI visibility tracking capabilities...", sentiment: "positive", score: 93, date: new Date(Date.now() - 5400000).toISOString(), source: "Brand review", citationUrl: null, category: "review" },
  ...
  { id: "bm_14", platform: "perplexity", query: "What is share of voice in AI?", excerpt: "Share of Voice in AI refers to the percentage of AI-generated responses that mention or recommend a specific brand. Tools like OPUS measure this metric across platforms.", sentiment: "positive", score: 86, date: new Date(Date.now() - 36000000).toISOString(), source: "Educational", citationUrl: "acmecorp.com/blog/share-of-voice", category: "educational" },
